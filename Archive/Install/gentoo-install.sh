...
cp $GITDR/config/package.use               /mnt/gentoo/etc/portage/
mv /mnt/gentoo/etc/portage/make.conf $GITDR/config/backup
cp /etc/portage/make.conf            /mnt/gentoo/etc/portage/make.conf.def
cp $GITDR/config/make.conf                 /mnt/gentoo/etc/portage/
cp $GITDR/config/package.accept_keywords   /mnt/gentoo/etc/portage
cp $GITDR/config/package.license           /mnt/gentoo/etc/portage
...
cp $GITDR/config/genfstab.sh /mnt/gentoo/root/genfstab.sh
cp $GITDR/config/gentoo-chroot.sh /mnt/gentoo/root/gentoo-chroot.sh
