...
wget http://distfiles.gentoo.org/releases/amd64/autobuilds/$latest_stage3 -P $GITDIR
...
cp $GITDIR/gentoo-chroot-zfs.sh /mnt/gentoo/root/gentoo-chroot-zfs.sh
chmod +x /mnt/gentoo/root/gentoo-chroot.sh
chroot /mnt/gentoo /mnt/gentoo/root/gentoo-chroot-zfs.sh
